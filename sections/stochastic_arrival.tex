...
Which we will refer to as the approximation factor. We note that an approximation ratio of $\alpha$ implies that $\frac{\E[\mathrm{ALG}]}{\E[\mathrm{OPT}]}$ is at least $\alpha-o(1)$

We will present the proof of two theorems in this chapter:

\begin{theorem}
	No algorithm has an approximation factor of $1$ in the iid model, ie there is a constant $c$ such that $\alpha<c$ for all algorithms
\end{theorem}
