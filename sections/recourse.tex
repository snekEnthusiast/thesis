...
\end{proof}
\begin{remark}
	The same logic can be used to prove that Matching with Recourse with general vertex arrival has a lower bound of $O(n^2)$, by having vertices arrive on both sides of a odd length path.
\end{remark}
