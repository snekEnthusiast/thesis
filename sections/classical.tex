...
\begin{definition}[Semi-Online Model]
	...
	When an online agent arrives edges incident to it are revealed. It has to be iether discarded or matched to an offline agent and that match cannot change later.
...
\begin{figure}[H]
	\centering
	\input{figures/semionline/adaptive.tikz}
\end{figure}
\begin{proof}
