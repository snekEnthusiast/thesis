...
\begin{lemma}
	The competitiveness ratio of Ranking in the Random Arrival model is lower bounded by $\inf\limits_{n\in N}\inf\limits_{u}\mathrm{expLP}(n,k)$ for any infinite subset of natural numbers $N$
\end{lemma}
\begin{proof}
