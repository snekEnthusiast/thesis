...
\begin{proof}
	...
	probability that $v$ is not matched is $1-x_t$. Expected cardinality of $R_{t-1}$ is $\sum\limits_{1\leq s\leq t-1}x_s$.\\
...
$G$ has a perfect matching implies that competitiveness is $\inf \frac{1}{n} \sum\limits_{1\leq s\leq n}x_s$.\\
