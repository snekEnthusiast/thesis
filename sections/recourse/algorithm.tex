...
\end{lemma}
\begin{proof}
	We will conduct the proof by induction over time $t$. Time at $t=0$ when no vertices have arrived forms a trivial base case with the maximal matching being $M=\emptyset$. For the induction step:
	Knowing
	\begin{enumerate}
