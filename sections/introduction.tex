...
\begin{enumerate}
	\setcounter{enumi}{1}
	\item Preliminaties
	\item The classical model introduced by Karp et al
	\item The advice model, where the algorithm may receive imperfect advice
	\item final degree model, where the degree of vertices in final graph is always known
\end{enumerate}