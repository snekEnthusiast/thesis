...
\begin{proof}
	...
	In the second phase $k$ vertices arrive connected to incrementally smaller parts of the upper $k$ offline vertices. Using an argument symmetrical to the one in \autoref{deg-diff-degree} we know that the matching here is maximum\\
	In total - all online vertices in the first phase have been matched and an expected half of the vertices in the second phase has been matched, resulting in an expected performance of $0.75$
\end{proof}
