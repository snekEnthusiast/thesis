...
RGA (\autoref{alg:RGA}) having an expected matching size of $\frac{n}{2}+O(\log n)$, it is expected to find a matching of size $n(1-\frac{1}{e})$ on a 
%reference
graph which is actually a subgraph of the degree counter-graph edgewise, meaning it would work at least as well here
