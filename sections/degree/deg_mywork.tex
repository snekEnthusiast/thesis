...
\begin{proof}
	...
	In the second phase $k$ vertices arrive connected to incrementally smaller parts of the upper $k$ offline vertices of which we expect half to be available for matching. Using an argument symmetrical to the one in \autoref{deg-diff-degree} we know that the matching here is maximum\\
